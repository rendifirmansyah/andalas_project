    ...
    @foreach($datas as $data)
        <tr class="odd gradeX">
            ...
            <td>{{$data->judul}}</td>
                        ...
                        <a href="{{ url('edit_berita/edit',$data->id) }}" class="btn btn-success btn-sm">Edit</a>
      ...
      <br><br><br>
      <a class="btn btn-link" href="{{url('produk/all')}}">Panel Produk</a>&nbsp;
      <a class="btn btn-link" href="{{url('about/all')}}">Panel About Us</a>&nbsp;
      <a class="btn btn-link" href="{{url('/gambar_home')}}">Ubah Gambar Home</a>&nbsp;
      <a class="btn btn-link" href="{{url('/footer/all')}}">Ubah Data Footer</a>&nbsp;
        ...
        <tr class="odd gradeX">
            ...
            @endif
                        ...
                        <td>
                            @if($user->id==1)
                            @else
                         <a href="{{ url('admin/delete',$user->id) }}" class="btn btn-danger btn-sm"  onclick="return confirm('Apakah Anda Yakin?')"
