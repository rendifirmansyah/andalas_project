    ...
    @foreach($admin as $user)
      ...
      <div class="pull-right">
         <form class="pure-form" role="form" method="get" action="{{ url('berita/search') }}">
                            &nbsp;&nbsp;&nbsp;
                            <input type="text" class="pure-input-rounded" name="query" placeholder="Cari bank" id="cari">
                            <input type="hidden" name="search" value="1">
                            <button type="submit" class="button-primary pure-button pure-input-rounded"><i class="fa fa-search"></i></button>
</form>
